...
def enrich_with_linked_data(raw_data: Dict[str, Any], source_system: str, 
...
def normalize_usda_texture(texture_class: str, sand_pct: float = None, 
                          clay_pct: float = None, silt_pct: float = None) -> Dict[str, Any]:
    """
...
if __name__ == "__main__":
    ...
    print(f"ENVO: {result['linked_data']['normalized']['curie']} - {result['linked_data']['normalized']['label']}")
