...
def calculate_coordinate_offset(lat: float, lon: float, distance_km: float, bearing_degrees: float) -> Tuple[float, float]:
    """
...
def find_nearest_station_distance(sample_lat: float, sample_lon: float, 
                                station_coordinates: list) -> Dict[str, Any]:
    """
